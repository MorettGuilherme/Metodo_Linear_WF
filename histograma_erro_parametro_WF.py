...
# Objetivo do código: análise do erro de estimação do parâmetro da amplitude, fase ou pedestal pelo método WF.

"""
Organização do Código:

Importação de arquivos.
Método WF para a estimação da amplitude, fase ou pedestal: metodo_WF.py

Funções presentes:

1) Função para o cálculo da estatística do erro de estimação da amplitude, fase ou pedestal pelo método WF.
...
2) Instrução para o plote do histograma do tipo A do erro de estimação da amplitude, fase ou pedestal pelo método WF.
Entrada: lista com os erros de estimação da amplitude, fase ou pedestal e seus dados estatísticos.
Saída: nada.

3) Instrução para o plote do histograma do tipo B do erro de estimação da amplitude, fase ou pedestal pelo método WF.
...
titulo_programa = colored("Análise do erro de estimação da amplitude, fase ou pedestal pelo método Filtro de Wiener (Wiener Filtering - WF):\n", attrs=["bold"])

# Impressão do título do programa.
print(titulo_programa)

### ---------- 1) FUNÇÃO PARA O CÁLCULO DOS DADOS ESTATÍSTICOS DO ERRO DE ESTIMAÇÃO DA AMPLITUDE, FASE OU PEDESTAL PELO MÉTODO WF ------------ ###

# Definição da função para o cálculo dos dados estatísticos do erro de estimação da amplitude, fase ou pedestal pelo método WF.
def dados_estatisticos_erro_estimacao_parametro_WF(lista_erro_estimacao_parametro):
...
### ------- 2) INSTRUÇÃO PARA A CONSTRUÇÃO DO HISTOGRAMA DO TIPO A DO ERRO DE ESTIMAÇÃO DA AMPLITUDE, FASE OU PEDESTAL PELO MÉTODO WF -------- ###

# Definição de instrução para o plot do histograma do tipo A do erro de estimação da amplitude, fase ou pedestal pelo método WF.
def histograma_A_erro_estimacao_parametro_WF(n_ocupacao, parametro, lista_erro_estimacao_parametro, media_erro_estimacao_parametro, var_erro_estimacao_parametro, desvio_padrao_erro_estimacao_parametro):
...
def principal_histograma_erro_estimacao_parametro_WF():
    ...
    if tipo_histograma == "A":
        ...
        lista_erro_estimacao_parametro = metodo_WF(Matriz_Pulsos_Sinais_Treino_Janelado, Matriz_Pulsos_Sinais_Teste_Janelado, vetor_parametro_referencia_treino_janelado, vetor_parametro_referencia_teste_janelado)

        media_erro_estimacao_parametro, var_erro_estimacao_parametro, desvio_padrao_erro_estimacao_parametro = dados_estatisticos_erro_estimacao_parametro_WF(lista_erro_estimacao_parametro)
    
        histograma_A_erro_estimacao_parametro_WF(n_ocupacao, parametro, lista_erro_estimacao_parametro, media_erro_estimacao_parametro, var_erro_estimacao_parametro, desvio_padrao_erro_estimacao_parametro)
    ...
    # Caso a variável tipo_histograma seja "B".
        ...
        lista_erro_estimacao_parametro_J7 = metodo_WF(Matriz_Pulsos_Sinais_Treino_Janelado_J7, Matriz_Pulsos_Sinais_Teste_Janelado_J7, vetor_parametro_referencia_treino_janelado_J7, vetor_parametro_referencia_teste_janelado_J7)
        media_erro_estimacao_parametro_J7, var_erro_estimacao_parametro_J7, desvio_padrao_erro_estimacao_parametro_J7 = dados_estatisticos_erro_estimacao_parametro_WF(lista_erro_estimacao_parametro_J7)
    
        lista_erro_estimacao_parametro_J15 = metodo_WF(Matriz_Pulsos_Sinais_Treino_Janelado_J15, Matriz_Pulsos_Sinais_Teste_Janelado_J15, vetor_parametro_referencia_treino_janelado_J15, vetor_parametro_referencia_teste_janelado_J15)
        media_erro_estimacao_parametro_J15, var_erro_estimacao_parametro_J15, desvio_padrao_erro_estimacao_parametro_J15 = dados_estatisticos_erro_estimacao_parametro_WF(lista_erro_estimacao_parametro_J15)
    
        lista_erro_estimacao_parametro_J19 = metodo_WF(Matriz_Pulsos_Sinais_Treino_Janelado_J19, Matriz_Pulsos_Sinais_Teste_Janelado_J19, vetor_parametro_referencia_treino_janelado_J19, vetor_parametro_referencia_teste_janelado_J19)
        media_erro_estimacao_parametro_J19, var_erro_estimacao_parametro_J19, desvio_padrao_erro_estimacao_parametro_J19 = dados_estatisticos_erro_estimacao_parametro_WF(lista_erro_estimacao_parametro_J19)
    
        histograma_B_erro_estimacao_parametro_WF(n_ocupacao, parametro, lista_erro_estimacao_parametro_J7, media_erro_estimacao_parametro_J7, var_erro_estimacao_parametro_J7, desvio_padrao_erro_estimacao_parametro_J7, lista_erro_estimacao_parametro_J15, media_erro_estimacao_parametro_J15, var_erro_estimacao_parametro_J15, desvio_padrao_erro_estimacao_parametro_J15, lista_erro_estimacao_parametro_J19, media_erro_estimacao_parametro_J19, var_erro_estimacao_parametro_J19, desvio_padrao_erro_estimacao_parametro_J19)
    
# Chamada da instrução principal do código.
principal_histograma_erro_estimacao_parametro_WF()
