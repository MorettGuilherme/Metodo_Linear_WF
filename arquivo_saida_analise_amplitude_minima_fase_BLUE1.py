...
titulo_programa = colored("Geração de arquivos de saída pela técnica de validação cruzada K-Fold para a análise do processo de estimação da fase pelo método Best Linear Unbiased Estimator (BLUE 1):\n", attrs=["bold"])
